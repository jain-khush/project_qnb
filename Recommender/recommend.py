...
# df = pd.read_csv('flipkart_data2.csv')
...
def create_product_card(index):
    ...
    card = dbc.Card(
        ...
        style={"width": "200px", 'height': 'auto'}, className='bg-gradient, m-2'
    ),
    ...
    dbc.Row([
        ...
        dbc.Row([
            dbc.Card([dbc.Row([
                ...
                dbc.Col([dcc.Upload(['Drag and Drop or ', html.A('Select an Image', href='#')],
                                    style={'width': '350px',
                                           'height': '80px',
                                           'lineHeight': '60px',
                                           'borderWidth': '1px',
            ...
            ], className='p-2 bg-gradient', style={'text-align': 'center', 'width': 'auto'})
        ], className='p-3', style={'text-align': 'center'}, align='center', justify='center'),
        html.Div(dbc.Badge('Recommendations', color='#85e35f', text_color='black')),
        html.Br(),
        dcc.Loading([
